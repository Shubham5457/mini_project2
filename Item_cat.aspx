<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Item_cat.aspx.cs" Inherits="online_product_auction_system.Item_cat" %>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="mail_section_1">
                        <h1 class="contact_taital">Item Category</h1>
    <form id="form1" runat="server">
   
            
     
                    <asp:TextBox ID="txt_cat_id" class="form-control" placeholder="Category ID " runat="server" Enabled="False"></asp:TextBox>
          <br />
                    <asp:TextBox ID="txt_cat_nm" class="form-control" placeholder="Category Name " runat="server" Enabled="False"></asp:TextBox>
            
        <br />

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btn_new" runat="server" Font-Bold="False"  class="btn-primary" Font-Size="Medium" OnClick="Button1_Click" Text="New" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btn_save" runat="server" Enabled="False"  class="btn-primary" Font-Bold="False" Font-Size="Medium" Text="Save" OnClick="btn_save_Click" OnClientClick="return formValidator()" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btn_update" runat="server" Enabled="False"  class="btn-primary" Font-Bold="False" Font-Size="Medium" Text="Update" OnClick="btn_update_Click" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btn_delete" runat="server" Enabled="False"  class="btn-primary" Font-Bold="False" Font-Size="Medium" Text="Delete" OnClick="btn_delete_Click" />
&nbsp;<br />
        <br />
        <br />
        <br />
