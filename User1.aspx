<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User1.aspx.cs" Inherits="online_product_auction_system.User1" %>
   ...
   <head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function formValidator(){
            ...
            var name = document.getElementById("txt_user_nm");
            var addr = document.getElementById("txt_user_addr");
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="mail_section_1">
                        <h1 class="contact_taital">User Registration</h1>
    <form id="form1" runat="server">
  
    
    
        
                    <asp:TextBox ID="txt_user_id" runat="server" class="form-control" placeholder="User ID"  ></asp:TextBox><br />
                
                    <asp:TextBox ID="txt_user_nm" runat="server" class="form-control" placeholder="Name"  ></asp:TextBox><br />
                
                    <asp:TextBox ID="txt_user_addr" runat="server" class="form-control" placeholder="Address"  ></asp:TextBox><br />
         
                    <asp:TextBox ID="txt_phone" runat="server" class="form-control" placeholder="Phone"  ></asp:TextBox><br />
                
                    <asp:TextBox ID="txt_email" runat="server" class="form-control" placeholder="Email"  ></asp:TextBox><br />
       
                
                    <asp:TextBox ID="txt_pass" runat="server" class="form-control" placeholder="Password"  ></asp:TextBox><br />
           
   
        <asp:Button ID="btn_save" runat="server" Text="Save"    class="btn-primary"  OnClick="btn_save_Click" OnClientClick="return formValidator()" />
